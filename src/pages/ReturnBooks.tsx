...
export const ReturnBooks = () => {
  ...
  const borrowedBooks = Array.isArray(borrowedBooksResponse)
  ...
  const availableBooks =
    books?.value.filter((book) => book.status === BookStatus.AVAILABLE) || [];

  // Get books borrowed by the selected member

  const memberBorrowedBooks =
    books?.value.filter(
      (book) =>
        ...
        <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-end">
                    <Button
                      ...
                      disabled={
                        !selectedMemberId || !selectedBookId || isBorrowing
                      }
                      className="w-full"
                    >
          ...
          <div className="mt-8">
            <h2 className="text-xl font-semibold mb-4">
              {selectedMemberId
                ? "Books Borrowed by Selected Member"
                ...
                [...borrowedBooks]
                  ...
                  .map((borrowing) => (
                    <TableRow key={borrowing.id}>
                      ...
                      <TableCell className="text-center">
                        {borrowing.fine !== 0 ? (
                          <p className="text-red-600">LKR {borrowing.fine}</p>
                        ) : (
                          "Not Late"
                        )}
                      </TableCell>
